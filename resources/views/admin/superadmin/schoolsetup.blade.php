                                        ...
                                        <div class="col-xs-12 col-sm-3 center">
                                            <div>
                                                <span class="profile-picture">
                                                    <img id="avatar" class="editable img-responsive" alt="schoo{{@$school->name}} logo" 
                                                     src="{{asset('assets/img/logo/'.@$school->logo) }}"/>
                                                </span>
                                                ...
                                                <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                                    <div class="inline position-relative">
                                                            ...
                                                            &nbsp;
                                                            <span class="white">Update School Logo</span>
                                            ...
                                            <form enctype="multipart/form-data" action="/schoolsetup" method="POST">
                                                <div class="form-group">
                                                    <span class="white">Update School Logo</span>
                                                        <input type="file" class="form-control-file" name="logo" style="margin-left: 28%; margin-right: 35%; padding-top: 5px; padding-bottom: 5px;">
                                            ...
                                            <div class="profile-user-info profile-user-info-striped">
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span class="editable" id="username"><strong>{{@$current_school_year->school_year}}</strong></span>
                                                    </div>
                                                </div>
